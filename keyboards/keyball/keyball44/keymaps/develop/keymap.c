...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_CAPS ,                                          KC_GRV , KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , 
                    SCRL_MO  , KC_LALT  ,  KC_LCTL,   LT(2, KC_SPC), KC_LSFT,                     LT(3,KC_BSPC), LT(1,KC_ENT)  ,   _______  , _______  , LT(4,KC_LGUI)
  ),
